...
android {
    namespace = "sn.uadb.gesabscence"
    compileSdk = 35

    defaultConfig {
        applicationId = "sn.uadb.gesabscence"
        minSdk = 26
        targetSdk = 35
        versionCode = 1
        versionName = "0.1.0"
...
// The Google Services plugin fails the build when google-services.json is missing.
// Keeps Module 1 buildable before Firebase is configured in Module 5.
